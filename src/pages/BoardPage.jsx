          ...
          return (
            ...
            >
              ...
              {isMenuOpen && (
                ...
                >
                  {/* RENAME */}
                  <button className="group flex items-center gap-2 w-full px-3 py-2 rounded-xl text-xs text-gray-300 hover:text-white hover:bg-white/10 transition-all duration-200">
              ...
              <div className="flex-1 space-y-2 overflow-y-auto">
                {list.tasks.map((task) => (
                  <div key={task.id} className="p-2 bg-white/10 rounded">
                    {task.text}
                  </div>
                ))}
              </div>
